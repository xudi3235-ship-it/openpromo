  ...
  return matchEntity(event, {
    content: (entity) => {
      ...
      return (
        ...
        <button
          className={cn(
            "w-full h-full rounded-lg border-0 transition-all relative overflow-hidden",
    ...
    group: (entity) => {
      ...
      return (
        ...
        >
          ...
          <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm text-gray-900 px-2 py-1 rounded-md text-xs font-semibold shadow-sm">
            Group
          </div>
