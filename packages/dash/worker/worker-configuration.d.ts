/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker/worker-configuration.d.ts` (hash: 11208d68a20f83bceaf4190f56dbb122)
// Runtime types generated with workerd@1.20251011.0 2025-10-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WorkspacePusher" | "ContainerBackend" | "WorkspaceSyncCoordinator" | "ApiRateLimitCoordinator";
	}
	interface Env {
		...
		CLOUDFLARE_STREAM_CUSTOMER_DOMAIN: string;
		DATABASE_URL: string;
		...
		FAL_API_TOKEN: string;
		GEMINI_API_KEY: string;
		HYPERDRIVE_ID: string;
		INSTAGRAM_APP_ID: string;
		INSTAGRAM_APP_SECRET: string;
		INSTAGRAM_TEST_ACCESS_TOKEN: string;
		INSTAGRAM_WEBHOOK_VERIFY_TOKEN: string;
		LIQUID_API_URL: string;
		MODAL_PROXY_AUTH_TOKEN_ID: string;
		MODAL_PROXY_AUTH_TOKEN_SECRET: string;
		MODAL_TOKEN_ID: string;
		MODAL_TOKEN_SECRET: string;
		NEON_API_KEY: string;
		NEON_PROJECT_ID: string;
		OPENAI_API_KEY: string;
		OPENPROMO_SECRET_KEY: string;
		PLANETSCALE_SERVICE_TOKEN: string;
		PLANETSCALE_SERVICE_TOKEN_ID: string;
		REPLICATE_API_TOKEN: string;
		STAINLESS_API_KEY: string;
		STRIPE_SECRET_KEY: string;
		TIKHUB_API_TOKEN: string;
		...
		ContentBackfillWorkflow: Workflow /* ContentBackfillWorkflow */;
		ProductProcessingWorkflow: Workflow /* ProductProcessingWorkflow */;
		ImageGenerationWorkflow: Workflow /* ImageGenerationWorkflow */;
		StyleComponentWorkflow: Workflow /* StyleComponentWorkflow */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_API_TOKEN" | "ANTHROPIC_API_KEY" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_DEFAULT_ACCOUNT_ID" | "CLOUDFLARE_IMAGE_ACCOUNT_HASH" | "CLOUDFLARE_R2_ACCESS_KEY_ID" | "CLOUDFLARE_R2_API_TOKEN" | "CLOUDFLARE_R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_STREAM_CUSTOMER_DOMAIN" | "DATABASE_URL" | "DOPPLER_CONFIG" | "DOPPLER_ENVIRONMENT" | "DOPPLER_PROJECT" | "DOPPLER_TOKEN" | "FACEBOOK_APP_ID" | "FACEBOOK_APP_SECRET" | "FACEBOOK_REDIRECT_URI" | "FACEBOOK_WEBHOOK_VERIFY_TOKEN" | "FAL_API_TOKEN" | "GEMINI_API_KEY" | "HYPERDRIVE_ID" | "INSTAGRAM_APP_ID" | "INSTAGRAM_APP_SECRET" | "INSTAGRAM_TEST_ACCESS_TOKEN" | "INSTAGRAM_WEBHOOK_VERIFY_TOKEN" | "LIQUID_API_URL" | "MODAL_PROXY_AUTH_TOKEN_ID" | "MODAL_PROXY_AUTH_TOKEN_SECRET" | "MODAL_TOKEN_ID" | "MODAL_TOKEN_SECRET" | "NEON_API_KEY" | "NEON_PROJECT_ID" | "OPENAI_API_KEY" | "OPENPROMO_SECRET_KEY" | "PLANETSCALE_SERVICE_TOKEN" | "PLANETSCALE_SERVICE_TOKEN_ID" | "REPLICATE_API_TOKEN" | "STAINLESS_API_KEY" | "STRIPE_SECRET_KEY" | "TIKHUB_API_TOKEN" | "TIKTOK_APP_ID" | "TIKTOK_APP_SECRET" | "UPSTASH_API_KEY" | "UPSTASH_EMAIL" | "VITE_DASHBOARD_URL" | "VITE_ENVIRONMENT" | "WORKOS_API_KEY" | "WORKOS_CLIENT_ID" | "WORKOS_COOKIE_PASSWORD">> {}
}
