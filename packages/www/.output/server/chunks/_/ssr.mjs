...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-C5CO8AXz.mjs');
...
const appCss = "/assets/app-hTVqMG3K.css";
...
const $$splitComponentImporter$1 = () => import('./about-tDWmeoFw.mjs');
const Route$1 = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./index-IW_zGqR0.mjs');
