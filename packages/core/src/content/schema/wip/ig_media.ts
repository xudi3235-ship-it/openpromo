...
export namespace IGMediaSchema {
    ...
    const ActionSchema = z
        ...
        .describe("Defines the mitigation steps taken based on the copyright owner's policy.");
                ...
                .array(
                    z.object({
                        duration_in_seconds: z
                            .number()
                            .describe("The number of seconds the content violates copyright."),
                        segment_type: z
                            .enum(["AUDIO", "VIDEO"])
                            .describe("The type of segment that contains the copyrighted content."),
                        start_time_in_seconds: z
                            .number()
                            .describe("The start time of the copyright violation in the video."),
                    }),
                )
                .describe("An array of objects detailing where the copyright violation occurs."),
            owner_copyright_policy: OwnerCopyrightPolicySchema,
        })
        .describe("Object containing information about a specific copyright match.");
    ...
    const CopyrightCheckInformationSchema = z
        ...
        .describe("Contains the status and results of a copyright check on the media.");

    export const Schema = z.object({
        alt_text: z.string().optional().describe("Descriptive text for images, for accessibility."),
        boost_ads_list: z
            .any()
            .optional()
            .describe(
        ...
        copyright_check_information: CopyrightCheckInformationSchema.optional().describe(
        ...
        is_comment_enabled: z
            .boolean()
            .optional()
            .describe("Indicates if comments are enabled or disabled. Excludes album children."),
        is_shared_to_feed: z
            .boolean()
            .optional()
            .describe(
        ...
        media_type: z.enum(["CAROUSEL_ALBUM", "IMAGE", "VIDEO"]).describe("The type of the media."),
        media_url: z
            .string()
            .url()
            .optional()
            .describe("The URL for the media. Omitted if the media contains copyrighted material."),
        owner: z
            .string()
            .optional()
            .describe(
        ...
        timestamp: z.string().datetime().describe("ISO 8601-formatted creation date in UTC."),
        username: z.string().describe("Username of the user who created the media."),
        view_count: z
            .number()
            .int()
            .optional()
            .describe("View count for Instagram reels. Available for Business Discovery API only."),
    });
}
