...
export namespace PagePostSchema {
    ...
    const PostAttachment: z.ZodType<PostAttachmentType> = z.lazy(() =>
        z.object({
            description: z.string().optional().describe("The description of the attachment."),
            media: z
                .object({
                    image: z
                        .object({
    ...
    export const Schema = z.object({
        ...
        admin_creator: z
            .union([IdNameObject, z.object({ id: z.string(), name: z.string().optional() })])
            .optional()
            .describe(
        ...
        can_reply_privately: z
            .boolean()
            .optional()
            .describe("Whether the page viewer can send a private reply to this post"),
        child_attachments: z
            .array(PostAttachment)
            .optional()
        ...
        event: z
            ...
            .optional()
            .describe("If this Post has a place, the event associated with the place"),
        expanded_height: z
            .number()
            .int()
            .optional()
        ...
        full_picture: z.string().url().optional().describe("Full size picture from attachment"),
        height: z
            .number()
            .int()
            .optional()
        ...
        is_app_share: z.boolean().optional().describe("Whether or not the post references an app"),
        ...
        is_hidden: z.boolean().optional().describe("Whether a post has been set to hidden"),
        is_inline_created: z
            .boolean()
            .optional()
            .describe("Returns True if the post was created inline when creating ads."),
        is_popular: z
            .boolean()
            .optional()
            .describe(
        ...
        is_spherical: z.boolean().optional().describe("Whether the post is a spherical video post"),
        ...
        status_type: z.string().optional().describe("Description of the type of a status update."),
        story: z
            .string()
            .optional()
            .describe(
        ...
        subscribed: z.boolean().optional().describe("Whether user is subscribed to the post"),
        ...
        via: IdNameObject.optional().describe("ID of the user or Page the post was shared from"),
        width: z
            .number()
            .int()
            .optional()
