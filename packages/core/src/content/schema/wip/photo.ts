...
export namespace PhotoSchema {
    ...
    export const Schema = z.object({
        ...
        created_time: z.string().datetime().describe("The time the photo was published."),
        event: IdNameObject.optional().describe("The event this photo is related to."),
        from: IdNameObject.optional().describe(
            "The profile (user or page) that uploaded the photo.",
        ),
        height: z.number().int().optional().describe("The height of the photo in pixels."),
        icon: z.string().url().optional().describe("The icon representing the photo type."),
        images: z
            .array(PhotoImageSchema)
            .optional()
            .describe("The different stored representations of the photo."),
        link: z.string().url().optional().describe("A link to the photo on Facebook."),
        name: z.string().optional().describe("The user-provided caption for the photo."),
        name_tags: z
            .array(
                IdNameObject.extend({
                    length: z.number(),
        ...
        webp_images: z
            .array(PhotoImageSchema)
            .optional()
            .describe("The different stored representations of the photo in WebP format."),
        width: z.number().int().optional().describe("The width of the photo in pixels."),
    });
}
