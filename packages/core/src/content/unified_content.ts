...
import { afterTx, createTransaction, Transaction } from "../drizzle/transaction";
...
export namespace UnifiedContent {
    ...
    function serialize(input: typeof unifiedContentTable.$inferInsert): z.infer<typeof Info> {
        return {
            id: input.id,
