import { z } from "zod";
import { FacebookAdsApi, Page, Photo, PagePost, AdVideo } from "facebook-nodejs-business-sdk";
...
const BackdatedTimeGranularity = z.enum(["year", "month", "day", "hour", "min", "none"]);

export const CreateFeedSchema = z
    .object({
        actions: z.record(z.any()).optional().describe("Actions that people can take on the post"),
        album_id: z.string().optional().describe("Album ID for photo posts"),
        android_key_hash: z.string().optional().describe("Android key hash for app links"),
        ...
        backdated_time: z.string().datetime().optional().describe("Backdated time for the post"),
        backdated_time_granularity: BackdatedTimeGranularity.optional().describe(
            "Granularity for backdated time",
        ),
        breaking_news: z.boolean().optional().describe("Whether this is breaking news"),
        ...
        call_to_action: z.record(z.any()).optional().describe("Call to action object"),
        ...
        composer_entry_picker: z.string().optional().describe("Composer entry picker"),
        composer_entry_point: z.string().optional().describe("Composer entry point"),
        ...
        composer_session_events_log: z.string().optional().describe("Composer session events log"),
        composer_session_id: z.string().optional().describe("Composer session ID"),
        composer_source_surface: z.string().optional().describe("Composer source surface"),
        ...
        coordinates: z.record(z.any()).optional().describe("Geographic coordinates"),
        ...
        feed_targeting: z.record(z.any()).optional().describe("Feed targeting specification"),
        ...
        home_checkin_city_id: z.record(z.any()).optional().describe("Home checkin city ID"),
        image_crops: z.record(z.any()).optional().describe("Image crop specifications"),
        implicit_with_tags: z.array(z.number().int()).optional().describe("Implicit tags"),
        instant_game_entry_point_data: z
            .string()
            .optional()
            .describe("Instant game entry point data"),
        ios_bundle_id: z.string().optional().describe("iOS bundle ID for app links"),
        is_backout_draft: z.boolean().optional().describe("Whether this is a backout draft"),
        is_boost_intended: z.boolean().optional().describe("Whether boost is intended"),
        is_explicit_location: z.boolean().optional().describe("Whether location is explicit"),
        is_explicit_share: z.boolean().optional().describe("Whether share is explicit"),
        is_group_linking_post: z
            .boolean()
            .optional()
            .describe("Whether this is a group linking post"),
        is_photo_container: z.boolean().optional().describe("Whether this is a photo container"),
        ...
        multi_share_end_card: z.boolean().optional().describe("Multi-share end card flag"),
        multi_share_optimized: z.boolean().optional().describe("Multi-share optimization flag"),
        ...
        og_action_type_id: z.string().optional().describe("Open Graph action type ID"),
        ...
        og_set_profile_badge: z.boolean().optional().describe("Whether to set profile badge"),
        og_suggestion_mechanism: z.string().optional().describe("OG suggestion mechanism"),
        ...
        place_attachment_setting: z.string().optional().describe("Place attachment setting"),
        place_list: z.string().optional().describe("Place list"),
        place_list_data: z.array(z.any()).optional().describe("Place list data"),
        post_surfaces_blacklist: z.array(z.string()).optional().describe("Post surfaces blacklist"),
        posting_to_redspace: z.string().optional().describe("Posting to redspace setting"),
        privacy: z.string().optional().describe("Privacy setting"),
        prompt_id: z.string().optional().describe("Prompt ID"),
        prompt_tracking_string: z.string().optional().describe("Prompt tracking string"),
        ...
        publish_event_id: z.number().int().nonnegative().optional().describe("Publish event ID"),
        ...
        referenceable_image_ids: z.array(z.string()).optional().describe("Referenceable image IDs"),
        referral_id: z.string().optional().describe("Referral ID"),
        scheduled_publish_time: z.string().datetime().optional().describe("Scheduled publish time"),
        ...
        suggested_place_id: z.record(z.any()).optional().describe("Suggested place ID"),
        tags: z.array(z.number().int()).optional().describe("List of user IDs to tag"),
        ...
        text_format_metadata: z.string().optional().describe("Text format metadata"),
        text_format_preset_id: z.string().optional().describe("Text format preset ID"),
        ...
        user_selected_tags: z.boolean().optional().describe("Whether tags are user selected"),
        ...
        viewer_coordinates: z.record(z.any()).optional().describe("Viewer coordinates"),
...
export const CreatePhotoSchema = z
    .object({
        ...
        allow_spherical_photo: z.boolean().optional().describe("Whether to allow spherical photos"),
        alt_text_custom: z
            .string()
            .optional()
            .describe("Accessible alternative description for an image"),
        android_key_hash: z.string().optional().describe("Android key hash"),
        application_id: z.string().optional().describe("iTunes App ID for native Share dialog"),
        attempt: z.number().int().nonnegative().optional().describe("Number of upload attempts"),
        audience_exp: z.boolean().optional().describe("Audience experiment flag"),
        backdated_time: z
            .string()
            .datetime()
        ...
        feed_targeting: z.record(z.any()).optional().describe("News Feed targeting for this post"),
        ...
        is_explicit_location: z.boolean().optional().describe("Whether location is explicit"),
        is_explicit_place: z.boolean().optional().describe("Whether tag is a place, not a person"),
        manual_privacy: z.boolean().optional().describe("Manual privacy setting"),
        message: z.string().optional().describe("Deprecated. Use caption param instead"),
        name: z.string().optional().describe("Deprecated. Use caption param instead"),
        no_story: z.boolean().optional().describe("Whether to suppress News Feed story creation"),
        offline_id: z.number().int().optional().describe("Offline ID"),
        og_action_type_id: z.string().optional().describe("Open Graph action type ID"),
        og_icon_id: z.string().optional().describe("Open Graph icon ID"),
        og_object_id: z.string().optional().describe("Open Graph object ID or URL"),
        og_phrase: z.string().optional().describe("Open Graph phrase"),
        og_set_profile_badge: z.boolean().optional().describe("Whether to create a profile badge"),
        og_suggestion_mechanism: z.string().optional().describe("Open Graph suggestion mechanism"),
        place: z
            .record(z.any())
            .optional()
            .describe("Page ID of a place associated with the photo"),
        privacy: z.string().optional().describe("Privacy settings of the photo"),
        profile_id: z.number().int().optional().describe("Deprecated. Use target_id instead"),
        provenance_info: z.record(z.any()).optional().describe("Provenance information"),
        proxied_app_id: z
            .union([z.string(), z.number().int()])
            .optional()
            .describe("Proxied app ID"),
        published: z.boolean().optional().describe("Whether to publish the photo immediately"),
        ...
        sponsor_relationship: z.number().int().optional().describe("Sponsor relationship type"),
        tags: z.array(z.record(z.any())).optional().describe("Tags on this photo"),
        target_id: z.number().int().optional().describe("Target ID (use edge endpoints instead)"),
        targeting: z.record(z.any()).optional().describe("Audience targeting for Pages"),
        time_since_original_post: z
            .number()
            .int()
            .optional()
...
export const CreateVideoSchema = z
    .object({
        ...
        backdated_post: z.array(z.any()).optional().describe("Backdated post configuration"),
        call_to_action: z.record(z.any()).optional().describe("Call to action configuration"),
        composer_entry_picker: z.string().optional().describe("Composer entry picker"),
        composer_entry_point: z.string().optional().describe("Composer entry point"),
        composer_entry_time: z
            .number()
        ...
        composer_source_surface: z.string().optional().describe("Composer source surface"),
        composer_type: z.string().optional().describe("Composer type"),
        container_type: z.string().optional().describe("Page videos container type"),
        content_category: z.string().optional().describe("Page videos content category"),
        content_tags: z.array(z.string()).optional().describe("Content tags"),
        creative_tools: z.string().optional().describe("Creative tools"),
        crossposted_video_id: z.string().optional().describe("Crossposted video ID"),
        ...
        end_offset: z.number().int().nonnegative().optional().describe("End offset"),
        ...
        feed_targeting: z.record(z.any()).optional().describe("Feed targeting settings"),
        file_size: z.number().int().nonnegative().optional().describe("File size in bytes"),
        file_url: z.string().optional().describe("URL of video file"),
        fisheye_video_cropped: z.boolean().optional().describe("Whether fisheye video is cropped"),
        ...
        initial_heading: z.number().int().nonnegative().optional().describe("Initial heading"),
        initial_pitch: z.number().int().nonnegative().optional().describe("Initial pitch"),
        instant_game_entry_point_data: z
            .string()
            .optional()
            .describe("Instant game entry point data"),
        is_boost_intended: z.boolean().optional().describe("Whether boost is intended"),
        is_explicit_share: z.boolean().optional().describe("Whether share is explicit"),
        is_group_linking_post: z.boolean().optional().describe("Whether post is group linking"),
        is_partnership_ad: z.boolean().optional().describe("Whether it's a partnership ad"),
        is_voice_clip: z.boolean().optional().describe("Whether it's a voice clip"),
        location_source_id: z.string().optional().describe("Location source ID"),
        manual_privacy: z.boolean().optional().describe("Manual privacy setting"),
        multilingual_data: z.array(z.record(z.any())).optional().describe("Multilingual data"),
        no_story: z.boolean().optional().describe("Whether to suppress story creation"),
        og_action_type_id: z.string().optional().describe("Open Graph action type ID"),
        og_icon_id: z.string().optional().describe("Open Graph icon ID"),
        og_object_id: z.string().optional().describe("Open Graph object ID"),
        og_phrase: z.string().optional().describe("Open Graph phrase"),
        og_suggestion_mechanism: z.string().optional().describe("Open Graph suggestion mechanism"),
        original_fov: z.number().int().nonnegative().optional().describe("Original field of view"),
        original_projection_type: z.string().optional().describe("Original projection type"),
        partnership_ad_ad_code: z.string().optional().describe("Partnership ad code"),
        publish_event_id: z.number().int().nonnegative().optional().describe("Publish event ID"),
        published: z.boolean().optional().describe("Whether to publish immediately"),
        reference_only: z.boolean().optional().describe("Whether it's reference only"),
        referenced_sticker_id: z.string().optional().describe("Referenced sticker ID"),
        ...
        slideshow_spec: z.record(z.any()).optional().describe("Slideshow specification"),
        social_actions: z.boolean().optional().describe("Whether social actions are enabled"),
        source: z.string().optional().describe("Video source"),
        source_instagram_media_id: z.string().optional().describe("Source Instagram media ID"),
        ...
        start_offset: z.number().int().nonnegative().optional().describe("Start offset"),
        ...
        unpublished_content_type: z.string().optional().describe("Unpublished content type"),
        upload_phase: z.string().optional().describe("Upload phase"),
        upload_session_id: z.string().optional().describe("Upload session ID"),
        upload_setting_properties: z.string().optional().describe("Upload setting properties"),
