...
import { type AllPlacement, PlacementSpecMapping } from "./schema/placement";
...
export namespace PendingContentGroup {
  ...
  function serialize(
    ...
    return {
      ...
      // biome-ignore lint/suspicious/noExplicitAny: TODO: refine this type
      baseSpec: input.baseSpec as any,
    };
  }
}
