...
class BasePlaywrightComputer:
    ...
    def upload_file(self, file_path: str, button_text: str) -> None:
        with self._page.expect_file_chooser() as fc_info:
            self._page.click(f"text={button_text}")
        file_chooser = fc_info.value
        if not file_chooser:
            raise ValueError(f"No file chooser found for button: {button_text}")
